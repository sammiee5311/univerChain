...
class RegistrationForm(forms.ModelForm):
    ...
    email = forms.EmailField(
        max_length=100, help_text="Required", error_messages={"required": "Please, type a valid email"}
    )
...
class EditForm(forms.ModelForm):
    email = forms.EmailField(
        label="Email",
        max_length=150,
        widget=forms.TextInput(attrs={"class": "form-control mb-3", "placeholder": "Email", "readonly": "readonly"}),
    )
...
class PasswordResetConfirm(SetPasswordForm):
    new_password1 = forms.CharField(
        label="New Password",
        widget=forms.PasswordInput(attrs={"class": "form-control mb-3", "placeholder": "New Password"}),
    )
    new_password2 = forms.CharField(
        label="Password Confirm",
        widget=forms.PasswordInput(attrs={"class": "form-control mb-3", "placeholder": "New Password Confirmation"}),
    )
